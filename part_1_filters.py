...
plt.title('(b) Resized Greyscale Image')
plt.axis('off')
plt.tight_layout()
plt.show()
...
plt.title('(c) Greyscale Image with Gaussian Noise')
plt.axis('off')
plt.tight_layout()
plt.show()
